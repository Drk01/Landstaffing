        ...
        <div class="panel-body">
            <form action="{{ route('save-account-data') }}" method="post" autocomplete="off"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" id="motherLastname">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="profile-picture">Foto de perfil: </label>
                    <input required type="file" name="profile-picture" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input required type="email" class="form-control" id="email" accept="image/*" />
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input required type="number" class="form-control" id="extN">
                        </div>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="col-lg-6">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-3">
                        <img src="{{ asset('Panel/images/img.jpg') }}" alt="Foto de perfíl" width="100px">
                    </div>
                    <div class="col-md-9">
